...
<div ref="elRef" class="qglefbjs" :class="notification.type">
	...
	<div class="tail">
		...
		<div v-once class="content">
			...
			<MkA v-else-if="notification.type === 'pollVote'" class="text" :to="notePage(notification.note)" :title="getNoteSummary(notification.note)">
				<i class="ti ti-quote"></i>
				<Mfm :text="getNoteSummary(notification.note)" :plain="true" :nowrap="!full"/>
				<i class="ti ti-quote"></i>
			</MkA>
			...
			<span v-else-if="notification.type === 'follow'" class="text">
			...
			<span v-else-if="notification.type === 'receiveFollowRequest'" class="text">{{ i18n.ts.receiveFollowRequest }}
